...
val fatJar = task("fatJar", type = Jar::class) {
  ...
  manifest {
    ...
    attributes["Service-Component"] = "OSGI-INF/com.example.ex9.SpellCheckerEx9Default.xml"  //this file is generated by OSGI; because we generate our own manifest (which is not recommended) then we need to add this file as a service component
  }
